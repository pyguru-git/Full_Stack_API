...
class Vote(Base):
    __tablename__ = "votes_alembic"
    user_id = Column(Integer, ForeignKey(
        "users_alembic.id", ondelete="CASCADE"), primary_key=True)
    post_id = Column(Integer, ForeignKey(
        "posts_alembic.id", ondelete="CASCADE"), primary_key=True)
